    ...
    <div id="formContainer" class="hidden bg-white shadow-md rounded-lg p-4">
      <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data" class="space-y-4">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
          <div x-data="imageViewer()">
            ...
            <template x-if="imageUrl">
              <img :src="imageUrl"
                  class="mt-2 w-full h-80 object-cover rounded-md border border-gray-200 cursor-pointer"
        ...
        <div class="block">
          ...
          <input id="title" name="title" autocomplete="title" type="text" class="form-input mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-75" autofocus value="{{old('title')}}">
          @error('title')
        ...
        <div class="block">
          ...
          <textarea id="body" name="body" class="ckeditor form-textarea mt-2 block w-full rounded-md border-gray-400 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-75">
            {{old('body')}}
          </textarea>
          @error('body')
        ...
        <div class="block">
          ...
          <select id="status" name="status" autocomplete="status" class="form-select mt-2 block w-6/12 rounded-md border-gray-400 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-75" required>
        ...
        <div class="block">
          ...
          <input id="keywords" name="keywords" autocomplete="keywords" type="text" class="form-input mt-2 block w-6/12 rounded-md border-gray-400 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-75">
        ...
        <div class="block">
          ...
          <select id="writer" name="writer" autocomplete="writer" class="form-select mt-2 block w-6/12 rounded-md border-gray-400 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-75" required>
